...
from .views import EntrepriseViewSet, ContactViewSet, LeadViewSet, AutomationRuleViewSet, dashboard_stats, get_commercials # [Modifié] Import de dashboard_stats
from .views import RegisterView, current_user, TacheViewSet
